...
public class DataLoader {
    ...
    /*
     * @Bean
     * CommandLineRunner loadData(UsuarioRepository usuarioRepo, QuadroRepository
     * quadroRepo,
     ...
     * quadro1.
     * setDescricao("Quadro para organizar tarefas do time de desenvolvimento.");
     ...
     * 
     * colunaRepo.saveAll(Arrays.asList(colunaToDo, colunaInProgress, colunaDone,
     * colunaMarketingToDo));
     * 
     * // Criando tarefas
     ...
     * tarefa2.
     * setDescricao("Desenvolver material para campanha de e-mail marketing.");
